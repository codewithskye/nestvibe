// Enhanced Mobile-Optimized JavaScript for NestVibe Realty
// Includes: Form handling, Chat bot, Location filtering, Mobile performance optimizations
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function submitForm(form, isRentalForm = false) {
        ...
        try {
            ...
            const response = await fetch('https://formspree.io/f/xkgbygwp', {
                method: 'POST',
                body: formData,
    ...
    function getChatResponse(message) {
        ...
        // Check for specific property search
        if (lowerMessage.includes('under') && lowerMessage.includes('$')) {
            ...
            if (priceMatch) {
                ...
                if (affordableProperties.length > 0) {
                    ...
                    return `Here are properties under $${maxPrice}:<br><br>${propertyList}<br><br><a href="properties.html" class="btn chat-btn">View All Properties</a>`;
                }
                return `I don't currently have properties under $${maxPrice}, but our most affordable option is the Orlando Resort Living at $1,650/month. <a href="properties.html" class="btn chat-btn">See All Options</a>`;
            }
        }
        ...
        // Default response
        return `I'd be happy to help you with that! I can assist with property information, pricing, applications, and more. Try asking about specific locations like "New York properties" or "Texas rentals", or let me know what you're looking for. <button onclick="fillChatInput('show me 2 bedroom apartments')" class="btn chat-btn">Show 2BR apartments</button>`;
    }

    // Audio notification system
    function playNotificationSound(type = 'send') {
        try {
            // Create an Audio object with the path to your local audio file
    ...
    function sendChatMessage() {
        ...
        // Show typing indicator and get bot response non-blocking
        showTypingIndicator();
        
        // Use requestAnimationFrame for non-blocking response
    ...
    // Global function for chat buttons
            ...
            if (properties.length === 0) {
                ...
                filteredProperties.innerHTML = properties.map(property => `
                    <div class="rental-card">
                        <div class="rental-image" style="background-image: url('https://images.unsplash.com/photo-1545324418-cc1a3fa10c00')"></div>
                        <h3>${property.name}</h3>
    ...
    function initScrollAnimations() {
        ...
        const elementsToObserve = document.querySelectorAll('.mobile-scroll, .slide-in-left, .slide-in-right, .fade-in, .form-side');
    ...
    function setupEventListeners() {
        ...
        if (elements.rentalForm && !elements.rentalForm.hasAttribute('data-listener-added')) {
            ...
            elements.rentalForm.addEventListener('submit', async (e) => {
                ...
                await submitForm(elements.rentalForm, true);
            });
        }
        ...
        if (elements.contactForm && !elements.contactForm.hasAttribute('data-listener-added')) {
            ...
            elements.contactForm.addEventListener('submit', async (e) => {
                ...
                await submitForm(elements.contactForm, false);
            });
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('touchmove', (e) => {
        // Allow scrolling in forms and chat
